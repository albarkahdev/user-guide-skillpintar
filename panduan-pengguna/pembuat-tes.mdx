...
Untuk tes **Public** yang **Active**, klik **Salin tautan tes** (Copy public link) di atas halaman tes — itu alamat halaman depannya (`/test-landing/[id]`) — lalu bagikan. Peserta mengisi **nama dan email**, lalu langsung mengerjakan — tanpa password. Akses peserta berlaku **4 jam**; dengan email yang sama ia bisa masuk lagi kapan saja.
